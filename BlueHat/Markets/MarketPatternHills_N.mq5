#include "MarketPatternHills_N.mqh"
void MarketPatternHills_N::Initialise(int max_history)
{
    ...
    for(int i=max-1; i>=0; i--)
        history[i]=(i%40>19)?(float)((40-i%40-1)%20-10)/10+NOISE(-0.2,0.2):(float)((i%40)%20-10)/10+NOISE(-0.2,0.2);
...
void MarketPatternHills_N::UpdateBuffers(int index)
{
